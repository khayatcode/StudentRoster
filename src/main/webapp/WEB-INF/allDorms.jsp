...
<body>
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark p-3">
        <div class="container-fluid">
            <a class="navbar-brand display-1" href="#" style="font-size: 24px;">Dorms</a>
            ...
            <tbody>
                <c:forEach var="dorm" items="${dorms}">
                    <tr>
                        ...
                        <td><a href="/dorm/show/${dorm.id}" class="btn btn-primary">See Students</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
