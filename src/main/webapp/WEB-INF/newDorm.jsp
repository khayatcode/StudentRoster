...
<body>
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark p-3">
		<div class="container-fluid">
			<a class="navbar-brand display-1" href="#" style="font-size: 24px;">Create Dorm</a>
    ...
    <div class="container mt-3">
		<form:form action="/dorm/create/new" method="post" modelAttribute="dorm">
            ...
            <div class="form-group">
                ...
                <form:input path="name" type="text" class="form-control mt-3" id="name" placeholder="Enter Dorm Name"/>
            </div>
            <input type="submit" class="btn btn-primary mt-3" value="Create Dorm"/>
		</form:form>
    </div>
